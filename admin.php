...
<body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            <div class="col-md-2 col-auto col-xl-2 px-sm-2 px-0 admin_sidebar">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="#" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span class="fs-5 d-none d-sm-inline admin_menu_text">Menu</span>
                    </a>
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start admin_sidebar_clr" id="menu">
                        <li>
                        ...
                        <li>
                            <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                ...
                                <span class="ms-1 d-none d-sm-inline">Edit</span> </a>
                        </li>
                        <li>
                            <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                        ...
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                                ...
                                <span class="ms-1 d-none d-sm-inline">Comment</span> </a>
                        </li>
                        <li>
                            <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                                ...
                                <span class="ms-1 d-none d-sm-inline">Members</span></a>
            ...
            <div class="col-md-10 admin_main">
                <div class="admin_wc">
                    <h5><a href="#">Welcome to Admin</a></h5>
                </div>
                <div>
